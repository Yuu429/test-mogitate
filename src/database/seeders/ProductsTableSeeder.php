...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $seasonIds = Season::pluck('id', 'name')->toArray();

        $products = [
            [
                'name' => 'キウイ',
                'price' => '800',
                'image' => 'fruits-img/fruits-img/kiwi.png',
            ...
            [
                'name' => 'ストロベリー',
                'price' => '1200',
                'image' => 'fruits-img/fruits-img/strawberry.png',
            ...
            [
                'name' => 'オレンジ',
                'price' => '850',
                'image' => 'fruits-img/fruits-img/orange.png',
            ...
            [
                'name' => 'スイカ',
                'price' => '700',
                'image' => 'fruits-img/fruits-img/watermelon.png',
            ...
            [
                'name' => 'ピーチ',
                'price' => '1000',
                'image' => 'fruits-img/fruits-img/peach.png',
            ...
            [
                'name' => 'シャインマスカット',
                'price' => '1400',
                'image' => 'fruits-img/fruits-img/muscat.png',
            ...
            [
                'name' => 'パイナップル',
                'price' => '800',
                'image' => 'fruits-img/fruits-img/pineapple.png',
            ...
            [
                'name' => 'ブドウ',
                'price' => '1100',
                'image' => 'fruits-img/fruits-img/grapes.png',
            ...
            [
                'name' => 'バナナ',
                'price' => '600',
                'image' => 'fruits-img/fruits-img/banana.png',
            ...
            [
                'name' => 'メロン',
                'price' => '900',
                'image' => 'fruits-img/fruits-img/melon.png',
        ...
        foreach ($products as $data) {
            ...
            $seasonIdsToInsert = array_map(function ($seasonName) use ($seasonIds) {
                return $seasonIds[$seasonName];
            }, $data['seasons']);

            foreach ($seasonIdsToInsert as $seasonId) {
